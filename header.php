...
<body>
    <header>
        ...
        <p class="haiku">My Year in Review:<br>to remember the good things<br>and prepare for new.</p>
      ...
      <ul class="find-me">
          <li class="open-social">
              <svg class="icon icon-user"><use xlink:href="assets/images/symbol-defs.svg#icon-user"></use></svg>
              <span class="screen-reader-text">Find Me Online:</span>
          </li>
          <ul class="social-menu">
              <li>
                  <a href="http://www.aaronsnowberger.com">
                  <svg class="icon icon-earth"><use xlink:href="assets/images/symbol-defs.svg#icon-earth"></use></svg>
